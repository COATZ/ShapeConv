...
class ShapeConv2d_sphe(Module):
    ...
    def __init__(self, in_channels, out_channels, kernel_size, D_mul=None, stride=1,
        ...
        super(ShapeConv2d_sphe, self).__init__()
    ...
    def __setstate__(self, state):
        super(ShapeConv2d_sphe, self).__setstate__(state)
    ...
    def _conv_forward(self, input, weight):
        if self.padding_mode != 'zeros':
            ...
            out = F.conv2d(F.pad(input, self._padding_repeated_twice, mode=self.padding_mode),
    ...
    def _load_from_state_dict(self, state_dict, prefix, local_metadata, strict,
        ...
        self.testing = not self.training
        super(ShapeConv2d_sphe, self)._load_from_state_dict(state_dict, prefix, local_metadata, strict,
                                                       missing_keys, unexpected_keys, error_msgs)
